...
import com.example.movieapp.databinding.TopRateMoviesBinding
...
class TopRateConcatAdapter (private val moviesAdapter: MovieAdapter): RecyclerView.Adapter<BaseConcatHolder<*>>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding = TopRateMoviesBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    private inner class ConcatViewHolder(val binding: TopRateMoviesBinding) : BaseConcatHolder<MovieAdapter>(binding.root) {
